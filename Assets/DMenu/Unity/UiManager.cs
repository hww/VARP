...
public partial class UiManager : UiObject
{
    ...
    private void Start()
    {
        ...
        var m1 = new KeyMap("Menu1", "?1", "Help1");
        ...
        var m = new KeyMap("Menu1", "?1", "Help1");
    ...
    private KeyMap testMenu;
    public UiMenu CreateTestMenu(Vector3 position)
    {
        if (testMenu == null)
        {
            testMenu = new KeyMap("Menu2", "?1", "Help2");
    ...
    public UiMenu CreateMenuBar(KeyMap menu, Vector3 position, float width = 0)
    {
        return menuBarFactory.CreateMenu(menu, position, width);
    }

    public UiMenu CreateMenu(KeyMap menu)
    {
        return menuFactory.CreateMenu(menu, Vector3.zero, 200f);
    }
